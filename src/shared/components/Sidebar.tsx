...
const items = [
	...
	},
	{
		...
		children: [
			...
			{
				label: 'PERFORMA MODAL Entry',
				key: '/dashboard/jurnal/performa-modal/entry/keyid',
			},
			{
				label: 'CTE',
			...
			{
				label: 'CTE Entry',
				key: '/dashboard/jurnal/cte/entry/keyid',
			},
			{
				label: 'ELIM',
			...
			{
				label: 'ELIM Entry',
				key: '/dashboard/jurnal/elim/entry/keyid',
			},
		],
	},
	{
		...
		children: [
			...
			{
				label: 'PEMBELIAN & PENJUALAN BERELASI',
				key: '/dashboard/upload/pembelian-&-penjualan-berelasi',
				icon: <FieldTimeOutlined />,
			},
			{
				label: 'MUTASI FA',
				key: '/dashboard/upload/mutasi-fa',
				icon: <FieldTimeOutlined />,
			},
			{
				label: 'MUTASI IA',
				key: '/dashboard/upload/mutasi-ia',
				icon: <FieldTimeOutlined />,
			},
			{
				label: 'MUTASI RUA',
				key: '/dashboard/upload/mutasi-rua',
				icon: <FieldTimeOutlined />,
			},
			{
				label: 'MUTASI DTA',
				key: '/dashboard/upload/mutasi-dta',
				icon: <FieldTimeOutlined />,
			},
			{
				label: 'DETAIL INVESTASI NON TBK',
				key: '/dashboard/upload/detail-investasi-non-tbk',
				icon: <FieldTimeOutlined />,
			},
		],
	},

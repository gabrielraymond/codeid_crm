...
import TablePembelianDanPenjualanBerelasi from './tablePembelianDanPenjualanBerelasi';

const { Search } = Input;

const PembelianDanPenjualanBerelasiComponents = () => {
	...
	return (
		<div>
			<HeaderPage title="UPLOAD PEMBELIAN & PENJUALAN BERELASI" />
			<div>
			...
			<div>
				<TablePembelianDanPenjualanBerelasi />
			</div>
		</div>
	);
};

export default PembelianDanPenjualanBerelasiComponents;

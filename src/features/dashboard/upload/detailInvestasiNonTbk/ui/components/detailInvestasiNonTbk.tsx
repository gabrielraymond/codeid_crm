...
import TableDetailInvestasiNonTbk from './tableDetailInvestasiNonTbk';

const { Search } = Input;

const DetailInvestasiNonTbkComponents = () => {
	...
	return (
		<div>
			<HeaderPage title="UPLOAD DETAIL INVESTASI NON TBK" />
			<div>
			...
			<div>
				<TableDetailInvestasiNonTbk />
			</div>
		</div>
	);
};

export default DetailInvestasiNonTbkComponents;

...
import TableMutasiPersediaan from './tableMutasiPersediaan';

const { Search } = Input;

const MutasiPersediaanComponents = () => {
	...
	return (
		<div>
			<HeaderPage title="UPLOAD MUTASI PERSEDIAAN" />
			<div>
			...
			<div>
				<TableMutasiPersediaan />
			</div>
		</div>
	);
};

export default MutasiPersediaanComponents;

...
import PerformaModalTable from './performaModalTable';

const { Search } = Input;

const PerformaModalComponents = () => {
	...
	return (
		<div>
			<HeaderPage title="JURNAL PERFORMA MODAL" />
			<div>
...
export default PerformaModalComponents;
